...
@Component({
    selector: 'app-menu',
    template: `
        <ul app-submenu [item]="model" root="true" class="layout-menu first-layout-menu" [reset]="reset" visible="true" parentActive="true"></ul>
    `
})
export class AppMenuComponent implements OnInit {
    ...
    ngOnInit() {
        this.model = [
            ...
            {
                label: 'Elementos', icon: 'fa fa-fw fa-bars',
                items: [
                    { label: 'Dashboard', icon: 'fa fa-fw fa-dashboard', routerLink: ['/dashboard'] },
                    { label: 'Página de ejemplo', icon: 'fa fa-fw fa-columns', routerLink: ['/sample'] },
                    { label: 'Formularios', icon: 'fa fa-fw fa-code', routerLink: ['/forms'] },
                    { label: 'Tablas', icon: 'fa fa-fw fa-table', routerLink: ['/data'] },
                    { label: 'Paneles', icon: 'fa fa-fw fa-list-alt', routerLink: ['/panels'] },
                    { label: 'Popup', icon: 'fa fa-fw fa-square', routerLink: ['/overlays'] },
                    { label: 'Menus', icon: 'fa fa-fw fa-minus-square-o', routerLink: ['/menus'] },
                    { label: 'Mensajes', icon: 'fa fa-fw fa-circle-o-notch', routerLink: ['/messages'] },
                    { label: 'Gráficos', icon: 'fa fa-fw fa-area-chart', routerLink: ['/charts'] },
                    { label: 'Archivos', icon: 'fa fa-fw fa-arrow-circle-o-up', routerLink: ['/file'] },
                    { label: 'Otros', icon: 'fa fa-fw fa-user-secret', routerLink: ['/misc'] }
                ]
            }
            /*{
    ...
    template: `
        <ng-template ngFor let-child let-i="index" [ngForOf]="(root ? item : item.items)">
            <li [ngClass]="{'active-menuitem': isActive(i)}" [class]="child.badgeStyleClass" *ngIf="child.visible === false ? false : true">
                <a [href]="child.url||'#'" (click)="itemClick($event,child,i)" (mouseenter)="onMouseEnter(i)" style="text-align: left;"
                ...
                <a (click)="itemClick($event,child,i)" (mouseenter)="onMouseEnter(i)" *ngIf="child.routerLink" style="text-align: left;"
